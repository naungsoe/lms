 ...
 */
@IndexDocument(namespace = "lms", collection = "courses")
public final class CourseResource implements Entity, Resource {

  private static final long serialVersionUID = 7354537653706208616L;
