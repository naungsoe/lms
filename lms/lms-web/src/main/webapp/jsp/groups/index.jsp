...
<head>
  ...
  <link rel="import" href="<c:url value="/static/web_components/module-groups/module-groups.html"/>">
  <title>
  ...
  <dom-module id="main-element">
    ...
    <script>
      HTMLImports.whenReady(function() {
        const localesUrl = '<c:url value="/webapi/locales/groups"/>';
        const filtersUrl = '<c:url value="/webapi/filters/groups"/>';
        const userUrl = '<c:url value="/webapi/users/${userId}"/>';
        const restUrl = '<c:url value="/webapi/groups"/>';
        const rootUrl = '<c:url value="/web/groups"/>';
