...
<head>
  ...
  <link rel="import" href="<c:url value="/static/web_components/module-users/module-users.html"/>">
  <title>
  ...
  <dom-module id="main-element">
    ...
    <script>
      HTMLImports.whenReady(function() {
        const localesUrl = '<c:url value="/webapi/locales/users"/>';
        const filtersUrl = '<c:url value="/webapi/filters/users"/>';
        const userUrl = '<c:url value="/webapi/users/${userId}"/>';
        const restUrl = '<c:url value="/webapi/users"/>';
        const rootUrl = '<c:url value="/web/users"/>';
        const contextRoot = '<c:url value="/web"/>';
        const language = '<c:out value="${locale}"/>';
        const error = '<c:out value="${error}"/>';
        const queryFields = 'firstName,lastName,account,email';
