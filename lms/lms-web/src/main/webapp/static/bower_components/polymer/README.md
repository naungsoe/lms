...
Polymer 2.0 is a major new release of Polymer that is compatible with the latest web components standards and web platform APIs, and makes significant improvements over the 1.x version of the library.  The following sectionComponent provides context and migration information for existing users of Polymer 1.x:
