 ...
 */
public final class MultipleResponse extends Question implements Serializable {

  private static final long serialVersionUID = -2141660772213813981L;
  ...
  public boolean equals(Object obj) {
    ...
    MultipleResponse question = (MultipleResponse) obj;
  ...
  public String toString() {
    return String.format(
        "MultipleResponse{id=%s, body=%s, hint=%s, explanation=%s, "
            + "options=%s, school=%s, levels=%s, subjects=%s, "
            + "keywords=%s, createdBy=%s, createdDateTime=%s, "
            + "modifiedBy=%s, modifiedDateTime=%s}",
        id, body, hint, explanation, StringUtils.join(options, ","),
